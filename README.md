...
Для оценки многообразия сервисов были выбраны школы как один из самых востребованных сервисов социальной инфраструктуры (относится к типу rival - конкурентный, так как школы имеют ограниченную вместимость учеников). 
