...
Кластеризация сервисов для выявления городских "подцентров". 
...
<br/>Для оценки многообразия сервисов были выбраны школы как один из самых востребованных сервисов социальной инфраструктуры (относится к типу rival - конкурентный, так как школы имеют ограниченную вместимость учеников). 
  
![image](https://github.com/ValentinBra/Project_Ekaterinburg/assets/115021474/70354331-aad2-43fa-88ca-b8fc24ec4883)

5.2 SFCA
2. Реализовать в коде Proportional 2SFCA. Оценить с помощью данного метода обеспеченность населения сервисами выбранного типа. Ответить на следующие вопросы?
	—  О чем говорят результаты данного метода применительно к выбранному типу сервиса?
	—  Какие недостатки данного метода можно отметить?
